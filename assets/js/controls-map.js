...
function init() {
    ...
    controls.enableDamping = true; // Requiere loop de animación
    ...
    // Mundo: Generación de 500 cubos (edificios) usando InstancedMesh para mejor rendimiento
    const geometry = new THREE.BoxGeometry();
    geometry.translate( 0, 0.5, 0 ); // Para que crezcan desde el suelo
